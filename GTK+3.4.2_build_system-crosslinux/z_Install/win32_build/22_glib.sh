...
./configure --host=i686-pc-mingw32 --with-pcre=internal --disable-static --enable-shared  --prefix="$PREFIX"
make clean
make 2>&1 | tee ../../logs/22_glib-make.log
make install 2>&1 | tee ../../logs/22_glib-makeinstall.log
