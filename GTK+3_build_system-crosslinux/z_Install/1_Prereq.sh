...
yum install -y mingw32-gcc mingw64-gcc git patch make autoconf automake gcc gperf gettext wget bison tar libtool which libxslt-devel python-lxml bzip2 gcc-c++
